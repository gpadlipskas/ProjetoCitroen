angular.module('app.controllers', [])
	.controller('pontoDeVendaCtrl', function ($cordovaGeolocation, $scope, $dataFactory) {
		...
		$cordovaGeolocation.getCurrentPosition().then((resp) => {
			...
			var mapOptions = { center: p0, zoom: 14, zoomControl: true, scaleControl: false, mapTypeControl: false, streetViewControl: false, mapTypeId: 'roadmap' };
			...
			Array.prototype.forEach.call($Ctrl.locais, locais => {
				...
				marker1[0] = new google.maps.Marker({ position: p1[0], animation: google.maps.Animation.DROP });
				google.maps.event.addListener(marker1[0], 'click', function () { infoWindow1[0].open(map, marker1[0]) });
